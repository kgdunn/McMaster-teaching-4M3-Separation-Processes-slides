...
\begin{frame}\frametitle{Example question}
	An ultrafiltration application is required to treat a waste stream that has 0.5 g protein per litre waste. Pilot plant studies show the flux can be expressed as 
	\[
