...
\begin{frame}\frametitle{Question (\emph{tomorrow})}
	An ultrafiltration application is required to treat a waste stream that has 0.5 g protein per litre waste. Pilot plant students show the flux can be expressed as 
	\[
	...
	\vspace{12pt}
	Will we have to dilute our feed, and if so, by how much, to avoid this fouling constraint?
\end{frame}
...
\begin{frame}\frametitle{Course evaluation feedback}
	\begin{center}
		\includegraphics[width=\textwidth]{\imagedir/separations/admin/evaluations-2012-things-you-like.png}
	\end{center}
\end{frame}

\begin{frame}\frametitle{}
	\begin{center}
		\includegraphics[width=\textwidth]{\imagedir/separations/admin/evaluations-2012-things-to-improve.png}
	\end{center}
\end{frame}

\begin{frame}\frametitle{}
	\begin{center}
		\includegraphics[width=\textwidth]{\imagedir/separations/admin/evaluations-2012-histograms.png}
	\end{center}
\end{frame}
