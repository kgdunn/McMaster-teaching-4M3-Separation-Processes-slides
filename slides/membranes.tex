...
\begin{frame}\frametitle{Example question}
	...
	\vspace{12pt}
	\begin{enumerate}
		\item	What is the flux $J_v$ at the membrane entrance?
		\item	What is the flux $J_v$ at the membrane exit if we are able to reach our desired end-point?
	\end{enumerate}
	% p 462, C+R2, v2, 5ed
\end{frame}
...
\begin{frame}\frametitle{Class example}
	...
	\[
		J = 0.02 \ln \left(\frac{25}{C_b} \right)
	\]
