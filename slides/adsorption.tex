...
\begin{frame}\frametitle{Example}
	...
	\begin{columns}[t]
		...
		\begin{enumerate}
			\item	Determine the breakpoint time, $\theta_b$ \iftoggle{instructor}{[{\color{myOrange}{Ans:}} 3.65 hours]}{}		
			\pause
			\item	What is the usable capacity of the bed? \iftoggle{instructor}{[{\color{myOrange}{Ans:}} the area $A_1$, up to time $\theta_b = 3.65~\text{hours}$]}{}
			\pause
				\begin{itemize}
		...
		\begin{enumerate}
			...
			\item	If the lab-scale bed were originally 14cm long, what length is unused at time $\theta_b$?
				\begin{itemize}
					...
					\item	where $L_\text{UNB}$ is the length of the unused bed
			...
			\begin{itemize}
				...
				\item	And fraction used = 20.4 / 24.5 = 0.83
			\end{itemize}
