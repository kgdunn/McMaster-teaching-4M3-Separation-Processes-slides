...
\begin{frame}\frametitle{Physical principles}
	\begin{exampleblock}{Adsorption releases heat. Why?}
		...
		$\Delta G = \Delta H - T \Delta S \quad \Longrightarrow  \quad \Delta H = \Delta G + T \Delta S \quad \Longrightarrow  \quad \Delta H < 0$
	\end{exampleblock}
...
\begin{frame}\frametitle{Langmuir isotherm derivation}
...
\begin{frame}\frametitle{Langmuir isotherm derivation}
	\begin{itemize}
		...
		\item	then \fbox{$C_\text{A,S} = \displaystyle \frac{K_\text{A}C_\text{T} P_\text{A}}{1 + K_\text{A} P_\text{A}} = \displaystyle \frac{K_1 P_\text{A}}{1 + K_2 P_\text{A}}$}
