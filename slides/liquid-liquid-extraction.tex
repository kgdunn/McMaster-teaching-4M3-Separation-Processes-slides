...
\iftoggle{instructor}{
	\begin{frame}\frametitle{Q3 {\color{myOrange}{\emph{solution}}}: Using the lever rule}		
		...
		\end{center}
		Composition of the mixture? Trick question: \emph{we need more information} (e.g. amount of $F$ {\color{myRed}{\textbf{and}}} $S$ must be given)
	\end{frame}
}{}
...
\begin{frame}\frametitle{Some theory: \emph{Counter-current} units}
	\begin{center}
