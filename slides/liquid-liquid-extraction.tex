...
% For 2014: reorder the questions
% Question 2
% Question 3
% Question 5
% Question 6
...
\iftoggle{student}{
	\begin{frame}\frametitle{Q2 {\color{myOrange}{\emph{solution}}}: Using the lever rule}
		...
		\end{center}
		Composition of the mixture? \emph{we need more information} (e.g. amount of $F$ \textbf{and} $S$ must be given to find point $M$)
	\end{frame}
}{}
...
\begin{frame}\frametitle{Q4: Altering flows}
	\begin{columns}[t]
		\column{0.8\textwidth}
			\begin{center}
				\includegraphics[width=0.85\textwidth]{\imagedir/separations/liquid-liquid-extraction/ternary-base-diagram-mixture-with-M.png}
...
\iftoggle{student}{
	\begin{frame}\frametitle{Q4 {\color{myOrange}{\emph{solution}}}: Altering flows}
		\begin{columns}[t]
			\column{0.8\textwidth}
				\begin{center}
...
\iftoggle{student}{
	\begin{frame}\frametitle{Q6 {\color{myOrange}{\emph{solution}}}: Composition of the 2 phases in equilibrium?}
		...
		\end{columns}
		$R_1 = 222\text{kg};\quad x_{R_1,A} = 0.10;\quad x_{R_1,C} = 0.82;\quad x_{R_1,S} = 0.08$ $E_1 = 128\text{kg};\quad y_{E_1,A} = 0.33;\quad y_{E_1,C} = 0.06;\quad y_{E_1,S} = 0.61$
	\end{frame}
}{}
