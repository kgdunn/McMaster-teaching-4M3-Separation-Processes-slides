...
\begin{frame}\frametitle{Definitions}
	...
	\vspace{12pt}
	{\color{purple}{Thickening}}: generally aims to increase the solids to higher concentration; higher throughput processes

	\vspace{12pt}
	{\color{purple}{Clarification}}: remove solids from a relatively dilute stream, usually aims for complete suspended-solids removal: units are deeper, and have provision for {\color{purple}{coagulation}} of feed.
...
%
% Note: the class on 13 September 2012 did not go well. Please watch the video again.
% I felt the slides were poorly ordered; for example, I had to jump forward to the slide
% on sludge interface experiments to show what they were.
% I feel that I should have covered the 4 settling zones earlier. Other reordering would
...
% 2013: explain why this is useful ... had several questions on what this slide is trying to say
\begin{frame}\frametitle{Sludge interface experiments}
...
\begin{frame}\frametitle{Another picture: use in 2013}
	\begin{center}
...
% 2013: fix chapter reference for Schweitzer
