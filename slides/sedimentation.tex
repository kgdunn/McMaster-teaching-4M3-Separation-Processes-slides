...
\begin{frame}\frametitle{Practice questions}
	A rectangular settling basin is used for clarifying a mixed biomass stream at a feed rate of 130 $\text{m}^{3}$ per hour. The basin area is 5000~$\text{m}^{2}$, the biomass density is 1100 kg.$\text{m}^{-3}$. 
	
	\vspace{12pt}
	
	There are biomass particles with approximately the following sizes present: 5\micron, 8.5\micron, 11.5\micron~and 20\micron. Which particle sizes will be completely separated out?	
\end{frame}
