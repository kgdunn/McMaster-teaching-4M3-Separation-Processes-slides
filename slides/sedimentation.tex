...
\begin{frame}\frametitle{Flocculation}
	...
	\begin{center}
		\includegraphics[width=0.7\textwidth]{\imagedir/separations/sedimentation/flocculation-Perry-ch22.png}
	\end{center}
	\see{Perry, 8ed, Ch22}
	\begin{itemize}
...
\begin{frame}\frametitle{Sludge interface experiments}
	...
	\vspace{12pt}	
	In practice: we will rely on outside consultants and civil engineers, most likely, to size and design the unit. Else see the references at end for more details.
\end{frame}
...
\begin{frame}\frametitle{Settler design rules of thumb: size}
	...
	\begin{itemize}
		...
		\item	circular sedimentation tanks having a minimum diameter of 6.0 m 
...
\begin{frame}\frametitle{Feed area: feedwell}
	We must aim to minimize turbulence from entry velocity and avoid disruption to existing settling.
	
	Also must avoid breaking up existing flocs.
...
\begin{frame}\frametitle{Further references to explore}	
	\begin{itemize}
		...
		\item	Svarovsky, ``Solid Liquid Separation'', 3rd or 4th edition. Particularly regarding the settler's mechanical accessories: pumps, scrapers, \emph{etc}.
	\end{itemize}
