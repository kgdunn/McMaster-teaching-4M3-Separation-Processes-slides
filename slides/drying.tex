...
\begin{frame}\frametitle{Drying: the heat and mass transfer view points}
	...
	\vspace{12pt}
	\begin{itemize}
		\item	Key point: heat to vapourize the liquid is provided by the air stream
		\item	The $\Delta H_\text{vap}$ at a function of the temperature at which it occurs
		\begin{itemize}
...
\begin{frame}\frametitle{Administrative}
	...
	\end{exampleblock}
	\begin{itemize}
		\item	Currently 42\% of the class have filled it in
	\end{itemize}
	\begin{center}
