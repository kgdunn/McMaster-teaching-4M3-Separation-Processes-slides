...
\begin{frame}\frametitle{Filter cake drying example}
	...
	\end{columns}
	\vspace{12pt}
	Consider 100kg of cake, discharged at 30\% moisture (wet basis). Air to dry the cake at 75\degC$\,$ is used, 10\% relative humidity, with a velocity of 4 m/s parallel to the solids, which are $2\,\text{m}^2$. The aim is to achieve a 10\% (dry basis) cake which can be milled and packaged. 
