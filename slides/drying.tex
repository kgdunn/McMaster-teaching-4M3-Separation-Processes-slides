...
\begin{frame}\frametitle{Filter cake drying example}
	\begin{enumerate}
		...
		\begin{itemize}
			\item	drying time = $\displaystyle  \frac{(\Delta M_\text{water}) (\Delta H_\text{vap})}{hA(T_\text{db} - T_\text{wb})} =$ {\scriptsize $\displaystyle \frac{(29.3)(2401\times 1000)}{(41.7)(2)(75-41.3)} =$} {\tiny \color{myOrange}{$\mathbf{6.95\,\textbf{hrs}}$}}
