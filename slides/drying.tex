...
\begin{frame}\frametitle{Exercise}
	...
	\begin{enumerate}
		...
		\item	What is the percentage humidity of the air stream leaving?  \iftoggle{instructor}{\visible<3->{{\color{myOrange}{[100\%]}}}}{}
		\item	What is the humidity [mass/mass] of the air stream leaving? \iftoggle{instructor}{\visible<4->{{\scriptsize{\color{myOrange}{[66g/kg]}}}}}{}
		\item	What is the temperature of the air stream leaving? \iftoggle{instructor}{\visible<5->{{\color{myOrange}{[45\degC]}}}}{}
		...
		\iftoggle{instructor}{\visible<6->{{\color{myOrange}{[$(66-55) = 11$ g per min]}}}}{}
	\end{enumerate}}
