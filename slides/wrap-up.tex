...
\begin{frame}\frametitle{Can't remember what was covered when?}
	...
	\end{exampleblock}
	\begin{center}
		\includegraphics[width=\textwidth]{\imagedir/separations/admin/course-videos-2013.png}
	\end{center}
\end{frame}
...
\begin{frame}\frametitle{Centrifuges: {\color{Brown}{\texttt{03B, 03C}}}}
	\begin{itemize}
...
\begin{frame}\frametitle{Cyclones: {\color{Brown}{\texttt{04A, 04B}}}}
	% \begin{itemize}
...
\begin{frame}\frametitle{Filtration: {\color{Brown}{\texttt{04C, 05A, 05B}}}}
	\begin{itemize}
		{\color{myGreen}
...
\begin{frame}\frametitle{Membranes: {\color{Brown}{\texttt{05C} to \texttt{09A}}}}
	\textbf{We studied}:
	\begin{itemize}
...
\begin{frame}\frametitle{Liquid-liquid extraction {\color{Brown}{\texttt{10A} to \texttt{11B}}}}
...
\begin{frame}\frametitle{Adsorption {\color{Brown}{\texttt{11C} to \texttt{12C}}}}
	\begin{itemize}
...
\begin{frame}\frametitle{Drying {\color{Brown}{\texttt{13A, 13B, 13C}}}}
	\begin{itemize}
		\item	heat transfer
		\item	mass transfer
