...
% For 2013: include section on costing: See Don Woods book: what is the cost basis, what are electrical costs (how to estimate electrical requirements) and maintenance costs (typically 5 to 10% of capital)
% Also see Perry's: have a table of costs related to Sigma value
...
% 2013: clearly explain several things here (improve the drawing; also SHOW A VIDEO <--- important of the tubular bowl centrifuge)
% 1. the wall of water is vertical
% 2. diagram should show top view of two concentration rings with the open air gap
% 3. video should show wall of water collapsing as the centrifuge spins down
% 4. illustration should show the solids entering at the bottom and being immediately spun into the r_1 wall
