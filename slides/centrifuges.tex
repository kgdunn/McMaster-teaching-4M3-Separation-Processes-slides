...
\begin{frame}\frametitle{Sigma theory for centrifuges}
	...
	we obtain:
	\[
		Q_\text{cut} =  \left( \frac{\left( \rho_p - \rho_f \right) g D_{p,\text{cut}}^2}{18 \mu_f}  \right) \cdot ( \Sigma ) =  v_\text{TSV} \cdot \Sigma
	\]
	\[
...
\begin{frame}\frametitle{Why use the Sigma term?}
	\begin{itemize}
		...
		\item	Centrifuge A: $Q_{\text{cut},A} = v_\text{TSV} \cdot \Sigma_A$
		\item	Centrifuge B: $Q_{\text{cut},B} = v_\text{TSV} \cdot \Sigma_B$
		\item	\[
