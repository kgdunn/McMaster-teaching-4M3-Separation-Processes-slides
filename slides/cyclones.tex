...
\begin{frame}\frametitle{Alternatives}
	...
	\begin{center}
		\includegraphics[width=0.8\textwidth]{\imagedir/separations/cyclones/cyclone-alternative-CRv2-5ed-p81.png}
	\end{center}	
...
\begin{frame}\frametitle{Velocity profiles}
	...
	\begin{itemize}
		...
		\item	velocities: those are our degrees of freedom to operate the cyclone
...
\begin{frame}\frametitle{Back to grade efficiency}
	...
	\begin{itemize}
		...
		\item	and the other half in the underflow; 50-50 (mass) split in the two outlets for particles of size $x$. Called the ``{\color{myRed}{cut size}}''.
