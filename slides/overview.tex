	...
	\begin{itemize}
		...
		\item	Optimal group work: one approach
			\begin{itemize}
				...
				\item	Both Daryl and Kevin do {\color{myRed}{\textbf{all questions}}} in draft: quick notes at home, \emph{etc}, $\pm 4$ days before assignment due, or earlier
