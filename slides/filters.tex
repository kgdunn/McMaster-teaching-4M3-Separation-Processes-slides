...
\begin{frame}\frametitle{Deriving the flow through the filter}
	...
	\[
		\begin{array}{rcl}
			\dfrac{-\Delta P_c}{L_c} &=& k_1 \cdot \mu \cdot \dfrac{v}{\epsilon} \cdot \left( \dfrac{(1-\epsilon)S_0}{\epsilon} \right)^2\\
			v &=& \dfrac{\left(-\Delta P_c\right) (\epsilon)^3}{(k_1) (L_c) (\mu) (1-\epsilon)^2 (S_0^2)}\\
			L_c &=&  \dfrac{C_S V}{A \left(1-\epsilon\right)\rho_p}\qquad\text{so sub this in} \\
			v &=& \dfrac{\left(-\Delta P_c\right) (\epsilon)^3 (A) \left(1-\epsilon\right)(\rho_p)}{(k_1) (C_S) (V) (\mu) (1-\epsilon)^2 (S_0^2)}\\
		\end{array}
	\]
