...
default:
	pdflatex --shell-escape --jobname=$(SUBDIR)2013-4M3-class-04 $(MAIN).tex;
    
	open $(SUBDIR)2013-4M3-class-04.pdf
...
$(CLASSES): %:
	...
	pdflatex --shell-escape --jobname=$(SUBDIR)2013-4M3-class-$* $(MAIN).tex;
    
	open $(SUBDIR)2013-4M3-class-$*.pdf
